 ...
 * @LastEditors: ider
 * @LastEditTime: 2020-09-04 14:45:26
 * @Description:
 -->
...
<script>
import { magCategory, extendEchartsOpts, extendLineSeries, defaultCategorySelect } from '@/api/data'
...
export default {
  ...
  methods: {
    ...
    async getData() {
      ...
      this.myChartObjs[1].setOption(chartOpt2, true)
      ...
      const chartOpt3 = this.setOptions(data, {
        xname: '节点规模数',
        xtype: 'value',
        subtext: '学科内头部排名组成的联通节点数为 X 的小世界网络'
      })
      this.myChartObjs[2].setOption(chartOpt3, true)
