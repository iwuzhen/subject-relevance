...
const cdn = {
  css: [
    ...
    "https://cdn.staticfile.net/MaterialDesign-Webfont/7.0.96/css/materialdesignicons.min.css",
    // "https://cdn.staticfile.net/element-plus/2.2.8/index.min.css",
    "https://cdn.staticfile.net/font-awesome/6.1.1/css/all.css",
    // "//cdn.jsdelivr.net/npm/diff2html/bundles/css/diff2html.min.css",
    'https://cdn.staticfile.net/vuetify/2.6.7/vuetify.min.css',
  ...
  js: [
    'https://cdn.staticfile.net/vue/2.7.7/vue.min.js',
    'https://cdn.staticfile.net/vuetify/2.6.7/vuetify.min.js',
    'https://cdn.staticfile.net/vue-router/3.5.3/vue-router.min.js',
    ...
    "https://cdn.staticfile.net/lodash.js/4.17.21/lodash.min.js",
    "https://cdn.staticfile.net/d3/5.16.0/d3.min.js",
    ...
    "https://cdn.staticfile.net/echarts/5.3.3/echarts.min.js",
    "https://cdn.staticfile.net/axios/0.27.2/axios.min.js",
